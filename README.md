...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create mthomps4-remix-b215
  fly apps create mthomps4-remix-b215-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app mthomps4-remix-b215
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app mthomps4-remix-b215-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'mthomps4-remix-b215-staging' does not match app name in config file 'mthomps4-remix-b215'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name mthomps4-remix-b215-db
  fly postgres attach --app mthomps4-remix-b215 mthomps4-remix-b215-db

  fly postgres create --name mthomps4-remix-b215-staging-db
  fly postgres attach --app mthomps4-remix-b215-staging mthomps4-remix-b215-staging-db
  ```
